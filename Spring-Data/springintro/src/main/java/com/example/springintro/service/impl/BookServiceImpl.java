...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllBooksByAuthorName(String fName, String lastName) {
        return bookRepository.findAllByAuthor_FirstNameAndAuthor_LastNameOrderByReleaseDateDescTitle(fName, lastName)
                .stream()
    ...
    private Book createBookFromInfo(String[] bookInfo) {
        ...
        return new Book(editionType, releaseDate, copies, price, ageRestriction,
